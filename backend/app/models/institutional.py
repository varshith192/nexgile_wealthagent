...
class Plan(BaseModel):
    ...
    plan_type: Mapped[str] = mapped_column(String(32), default="401k")
    ...
    employer_match_formula: Mapped[str] = mapped_column(String(160), default="100% of first 4%")
    vesting_schedule: Mapped[str] = mapped_column(String(96), default="3-year cliff")
    ...
    recordkeeper: Mapped[str] = mapped_column(String(120), default="Meridian Retirement Services")
...
class Participant(BaseModel):
    ...
    roth_deferral_rate: Mapped[float] = mapped_column(Float, default=0.0)
    account_balance: Mapped[float] = mapped_column(Float, default=0.0)
    roth_balance: Mapped[float] = mapped_column(Float, default=0.0)
...
class Contribution(BaseModel):
    ...
    employee_roth: Mapped[float] = mapped_column(Float, default=0.0)
...
class InvestmentOption(BaseModel):
    ...
    is_qdia: Mapped[bool] = mapped_column(Boolean, default=False)
